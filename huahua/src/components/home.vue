...
<script>
	...
	const commonSortData = [{picUrl: '/static/img/flowers/baihe.png'},{picUrl: '/static/img/flowers/carnation.png'},{picUrl: '/static/img/flowers/baihe.png'},{picUrl: '/static/img/flowers/carnation.png'},{picUrl: '/static/img/flowers/baihe.png'}];
