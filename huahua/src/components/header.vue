...
<style scoped>
	...
	h1.logoItem a{display: block;width: 50px;height: 24px;background-image: url(../assets/img/logo_2.png);background-size: 50px 24px;}
	...
	.scrollLogo{background-image: url(../assets/img/logo.png)!important;}
</style>